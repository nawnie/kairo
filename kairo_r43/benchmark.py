    ...
    for ordinal, case in enumerate(load("private_cases.json")):
        ...
        with tempfile.TemporaryDirectory(prefix="kairo_r43_file_") as directory:
            ...
            def handle(request):
                ...
                return response
            host.handle = handle
            entry = "kairo_r22.file_client" if policy == "cold" else ("kairo_r44.client" if policy in ("backprop_challenges", "frontier_backprop", "coverage_backprop") else "kairo_r23.client")
